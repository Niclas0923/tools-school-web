...
<template>
  <!-- 刷新按钮 -->
  <button type="button" @click="list.refresh()" class="btn btn-success refreshBtn" >
  ...
  <!-- 上下替换的按钮 -->
  <button type="button" @click="list.changeUpDone()" class="btn btn-secondary changeBtn" >
  ...
  <!-- 删除标签的按钮 -->
<!--  <button type="button" @click="delBtn(now.id)" v-if="this.now.id" class="btn btn-danger delBtn">-->
